...
const submarkets = {
  ...
  2: {
    name: 'SUBMARKET 2',
    description:
      'Higher-priced near core and employment corridor neighborhoods.',
  ...
  4: {
    name: 'SUBMARKET 4',
    description:
      'Lower-priced core neighborhoods vulnerable to increasing housing costs.',
  ...
  6: {
    name: 'SUBMARKET 6',
    description:
      'Suburban neighborhoods with moderate-to-higher-priced housing.',
